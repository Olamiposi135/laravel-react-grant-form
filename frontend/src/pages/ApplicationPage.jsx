                            ...
                            <>
                                ...
                                <div className="space-y-10">
                                    <div className=" flex flex-col md:flex-row gap-7 items-center">
                                        ...
                                        <div className="w-full">
                                            <label className="required-input-label">
                                                Check the area of Grant you are
                                                interested in
                                            </label>
                                            <select
                                                name="grantSelect"
                                    ...
                                    <div>
                                        <label className="required-input-label">
                                            Describe in detail who you're apply
                                        ...
                                        <span className="text-lg my-2 block">
                                            Be specific about your needs and how
                                            this grant will help you achieve
                                            your goals.
                                        </span>
                                    </div>
                            ...
                            <div className="relative">
                                <div className="py-8 px-2 md:px-8 space-y-8 bg-gradient-to-br from-slate-900/90 via-slate-800/95 to-slate-900/90 rounded-2xl shadow-2xl border border-blue-900/10 max-w-3xl mx-auto">
                                    ...
                                    <div className="text-center text-blue-300 mt-6 text-base md:text-lg">
                                        Please confirm all details above before
                                        submitting. You can go back to edit if
                                        needed.
                                    </div>
                                </div>
                            </div>
                            ...
                            <div className="flex gap-4 ml-auto">
                                {currentStep < totalSteps && (
                                    <button
                                        ...
                                        type="button"
                                        onClick={nextStep}
                                        disabled={submitting || navLoading.next}
                                    >
                                        Next
                                        {navLoading.next ? (
